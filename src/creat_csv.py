# Código apenas para criação do csv que será processado (meus creditos nesse arquivo em especifico é somento ctrl + c e ctrl + v)
import os
import sys
import random
import time
...
def build_test_data(weather_station_names, num_rows_to_create):
    ...
    batch_size = 1_000 # instead of writing line by line to file, process a batch of stations and put it to disk
